        ...
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 12; x++) {
                ...
                if (getColor(red, green, blue).equals("WHITE")) {
                    map.add(new Platform(x * 100, y * 100, 100, 100, "STATIC", PostTransitionWorldAssets.block));
                } else if (getColor(red, green, blue).equals("GREEN")) {
                    map.add(new Platform(x * 100, y * 100, 100, 100, "ACTIVE", PostTransitionWorldAssets.block));
                }
            }
        }
    }
